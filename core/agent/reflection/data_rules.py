...
from ..orchestrator.agent_config import AGENT_DEFAULTS

logger = logging.getLogger(__name__)

# I2：阈值从 agent_config 默认值读取，保持现有行为不变
MIN_TRAIN_ROWS = AGENT_DEFAULTS["min_train_rows"]
MIN_VALID_RATIO = AGENT_DEFAULTS["min_valid_ratio"]
MIN_SPLIT_SHARE = AGENT_DEFAULTS["min_split_share"]
